...
fnSH = [5,5]     #file nodes skip header: number of lines
fnSF = [7,56]     #file nodes skip footer: number of lines -1
fbSH = [17,17]    #file branches skip header: number of lines
fbSF = [9,89]     #file branches skip footer: number of lines -1
fgSH = [5,5]     #file generators skip header: number of lines
fgSF = [3,69 ]    #file generators skip footer: number of lines -1
instances=0
...
def InitNeighbours(model, node):
    retval = []
    for link in k:
        if link['fromBus'] == node and link['toBus'] not in retval :
#if link['fromBus'] == node and link['toBus'] <200 :
